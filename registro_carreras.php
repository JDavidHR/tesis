                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="container" style="text-align: center">
                                    ...
                                    <fieldset>
                                        <center><a href="update_carreras.php"><button name="submit" type="submit" id="contact-submit" data-submit="...Sending" class="form-control col-2" style="background-color: #037537;color: white">Modificar Carrera</button></a></center>
                                    </fieldset>
                                    <fieldset>
                                        <center><a href="delete_carreras.php"><button name="submit" type="submit" id="contact-submit" data-submit="...Sending" class="form-control col-2" style="background-color: #037537;color: white">Eliminar Carrera</button></a></center>
                                    </fieldset>
                                </div>
                            </div>
                        </div>
