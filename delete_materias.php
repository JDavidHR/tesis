...
<body>
    ...
    if (!isset($_SESSION['tipousuario'])) {
        ...
        $seleccionmaterias = $mysql->efectuarConsulta("SELECT asistencia.materia.id_materia, asistencia.materia.nombre from materia where asistencia.materia.estado = 1");
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="container" style="text-align: center">
                                    <form id="contact" action="Controlador/delete_materia.php" method="post">
                                        <h3>Eliminar materia</h3>
                                        <h4>Selecciona el materia a eliminar</h4>
                                        ...
                                        <center>
                                            <fieldset>
                                                <select class="form-control col-md-6 col-md-offset-3" name="usuario" required>
                                                    <?php
                                                    //ciclo while 
                                                    while ($resultado = mysqli_fetch_assoc($seleccionmaterias)) {
                                                    ?>
