...
<body>
  ...
  $datosdocente = $mysql->efectuarConsulta("SELECT estudiante.id_estudiante, estudiante.nombres, estudiante.documento, estudiante.tipo_usuario_id_tipo_usuario, tipo_usuario.nombre from estudiante join tipo_usuario on tipo_usuario.id_tipo_usuario = estudiante.tipo_usuario_id_tipo_usuario where estudiante.id_estudiante = " . $id_estudiante . "");
      ...
      <div class="page-breadcrumb">
        <div class="row">
          <div class="col-5 align-self-center">
            <h4 class="page-title">Información de la Clase</h4>
                ...
                <form id="contact" action="clases_asistidas.php" method="post">
                  <div class="container col-md-7 col-md-offset-3" style="text-align: center">
                    ...
                    <div class="form-group row">
                      <fieldset>
                        <textarea name="comentarios" rows="5" cols="70" disabled placeholder="Escribe aquí una descripción..." ><?php echo $links ?></textarea>
                      </fieldset>
                    </div>
