...
<body>
    ...
    if (!isset($_SESSION['tipousuario'])) {
        ...
        $seleccionaulas = $mysql->efectuarConsulta("SELECT asistencia.aula.id_aula, asistencia.aula.nombre from aula where asistencia.aula.estado = 1");
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="container" style="text-align: center">
                                    <form id="contact" action="Controlador/delete_aula.php" method="post">
                                        <h3>Eliminar aula</h3>
                                        <h4>Selecciona el aula a eliminar</h4>
