...
if(isset($_POST['submit']) && !empty($_POST['radiobutton']) && !empty($_POST['documento_usuario']) && !empty($_POST['nombre_usuario']) && !empty($_POST['apellido_usuario']) && !empty($_POST['tipousuario']) && !empty($_POST['horario']) && !empty($_POST['Semestre'])  && !empty($_POST['carrera']) ){
