...
if(isset($_POST['submit']) && !empty($_POST['documento_docente']) && !empty($_POST['nombre_docente']) && !empty($_POST['apellido_docente']) && !empty($_POST['contrasena']) && !empty($_POST['tipousuario']) ){
        ...
        $sql=$mysql->efectuarConsulta("insert into asistencia.docente(documento,nombres,apellidos,contrasena,tipo_usuario_id_tipo_usuario) VALUES ('".$documento."','".$nombre."','".$apellido."','".$pass."','".$tipo."')");
